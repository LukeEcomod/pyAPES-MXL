...
def leaf_interface(photop,
    ...
    Last edit 26.02.2019 /SL: changed BWB-scheme (untested) and outcommented 'Medlyn' from alternatives
    """
...
#    Dleaf = np.maximum(EPS, esat / P - H2O)  # mol/mol
    ...
    while err > 0.01 and iter_no < itermax:
        ...
        #if model.upper() == 'MEDLYN': # medlyn-approach with co-limitation as in Vico et al. 2013
